...
const configvalues = ["production", "database", "cache"];
...
const productInfo = ["Gaming Mouse", 79];
...
const employee = [1001, "Sarah Johnson"];
...
const colorRGB = [255, 128, 64];
const userRecord = [42, "admin", true];
...
const firstScores = [85, 92, 78];
const secondScores = [88, 95, 82];
const allScores = [...firstScores, ...secondScores];
const bonusPoints = [5, 10];
const finalScores = [100, ...allScores, ...bonusPoints, 90];
...
const groceryItem = ["apples", 5];
const currentList = ["bread", "milk", "eggs"];
function addToShoppingLis(groceryItem, currentList) {
    let itemName = groceryItem[0];
    console.log(itemName);
    const newList = [...currentList, itemName];
    console.log(newList)
}
const bakeryItem = ["cookies", 2];
